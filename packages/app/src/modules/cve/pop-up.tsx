...
const SeverityDistributionPopup: React.FC<SeverityDistributionPopupProps> = ({
  open,
  onClose,
  severities,
}) => {
  // Aggregate the counts for each severity level
  const severityCounts: SeverityCounts = severities.reduce(
    (acc: SeverityCounts, severity) => {
